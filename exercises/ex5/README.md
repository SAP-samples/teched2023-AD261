...
1. Navigate to [TMS UI](https://ad261-calm-h7f2r9xc.ts.cfapps.eu10.hana.ondemand.com/main/webapp/index.html#/nodeObject/6) and select the PROD from Transport Nodes. 
   ...
   </br><img width="500" alt="image" src="images/TMSNodes.png">

2. Search for the transport request your user suffix "Teched  Demo Transport for AD261-XXX" and click on Import Selected.
</br><img width="500" alt="image" src="images/TMSProdTR.png">

3. Check the status of Import for target node "PROD" by clicking on "Action Logs"
</br><img width="500" alt="image" src="images/TMSTRActionLogs.png">
</br><img width="500" alt="image" src="images/TMSDetailActionLog.png">
...
</br><img width="500" alt="image" src="images/CAS-Prod.png">
...
</br><img width="500" alt="image" src="images/CAS-Prod-Content-Respurces.png">
...
</br><img width="500" alt="image" src="images/ALMConfirmDpeloyment.png">
</br><img width="500" alt="image" src="images/ALMConfirmDpeloymentOK.png">
